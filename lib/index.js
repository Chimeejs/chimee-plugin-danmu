...
var Canvas = function () {
  ...
  _createClass(Canvas, [{
    ...
    value: function destroy() {
      chimeeHelper.caf.call(window, this.timer);
    ...
    value: function render() {
      ...
      this.timer = chimeeHelper.raf.call(window, function () {
        _this.render();
      });
    }
...
var Css = (_class = function () {
  ...
  _createClass(Css, [{
    ...
    value: function render() {
      ...
      this.thread.pool.forEach(function (item, i) {
        chimeeHelper.setStyle(item.piece, 'transform', 'translateX(' + item.offset.x + 'px) translateY(' + item.offset.y + 'px) ');
        if (item.mode === 'flow') {
          item.offset.x -= item.speed;
      ...
      this.timer = chimeeHelper.raf.call(window, this.render);
    }
  ...
  return Css;
}(), (_applyDecoratedDescriptor(_class.prototype, 'render', [toxicDecorators.autobind], _Object$getOwnPropertyDescriptor(_class.prototype, 'render'), _class.prototype)), _class);
...
var Danma = function () {
  ...
  _createClass(Danma, [{
    ...
    value: function emit(data) {
      ...
      data = chimeeHelper.deepAssign(defaultData, danma);
...
__$styleInject("chimee-danmu{position:absolute;top:0;left:0;display:block;width:100%;height:100%;overflow:hidden}chimee-danmu>canvas,chimee-danmu>div{width:100%;height:100%;user-select:none}chimee-danmu .danmu-piece{position:absolute;left:0;top:0;display:inline-block;white-space:pre;pointer-events:none;font-weight:400;line-height:1.125;opacity:1;text-shadow:#000 1px 0 1px,#000 0 1px 1px,#000 0 -1px 1px,#000 -1px 0 1px}", undefined);
...
var chimeeDanmu = {
  ...
  init: function init(videoConfig) {
    ...
    chimeeHelper.addEvent(window, 'resize', this._resize);
  },
  inited: function inited() {},
  destroy: function destroy() {
    this.danmu.destroy();
    this.$dom.parentNode.removeChild(this.$dom);
    chimeeHelper.removeEvent(window, 'resize', this._resize);
  },
